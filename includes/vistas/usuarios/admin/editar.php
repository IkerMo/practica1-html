...
require_once RUTA_CLASES . '/Formularios/FormularioEditarUsuarioAdmin.php';
...
$form = new \es\ucm\fdi\aw\Formularios\FormularioEditarUsuarioAdmin($id);
$htmlForm = $form->gestiona();

$tituloPagina = 'Editar Usuario - Bistro FDI';
